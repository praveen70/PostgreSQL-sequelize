...
const Carddata = () => (
    <div style={{ background: '#ECECEC', padding: '25px' }}>
        <Card title="Deals of the Day" bordered={false} extra={<Button type="primary" ghost>VIEW ALL</Button>}>
            <div style={{ display: 'flex', marginTop: '10px' }}>
                <div className="ui special cards justify-content-between w-100" >
                    <Card bordered={false}
                        className="text-center "
                        cover={<img className="m-auto" alt="example" src="Redmi Note 7 Pro (From ₹13,999)" src="https://rukminim1.flixcart.com/image/300/300/shoe/q/e/h/sx0277g-7-sparx-blue-original-imaeqgfyzgmgpp4n.jpeg?q=70" />}>
                    ...
                    <Card bordered={false}
                    className="text-center"
                        cover={<img alt="example" className="m-auto"  src="Redmi Note 7 Pro (From ₹13,999)" src="https://rukminim1.flixcart.com/flap/300/300/image/7599515653b7150f.jpg?q=70" />}>
                    ...
                    <Card bordered={false} className="text-center"
                        cover={<img alt="example" className="m-auto"  src="Redmi Note 7 Pro (From ₹13,999)" src="https://rukminim1.flixcart.com/flap/300/300/image/050993a5517eeb9c.jpg?q=70" />}>
                    ...
                    <Card bordered={false} style={{ minHeight: '100%' }} className="text-center"
                        cover={<img alt="example" className="m-auto"  src="Redmi Note 7 Pro (From ₹13,999)" src="https://rukminim1.flixcart.com/image/300/300/wardrobe-closet/y/v/v/nv-001k-carbon-steel-novatic-navy-blue-original-imaekx7egff8qvwp.jpeg?q=70" />}>
