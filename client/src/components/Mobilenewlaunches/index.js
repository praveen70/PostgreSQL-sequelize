...
const Newmobile = () => (
    <div style={{ background: '#ECECEC', padding: '30px', justifyContent: "space-between"}}>
        <Card title="Best Camera Smartphones" bordered={false} extra={<Button type="primary" ghost>VIEW ALL</Button>}>
            <div style={{display: 'flex', marginTop: '10px' , justifyContent: 'space-between'}}>
                <div class="ui special cards justify-content-between w-100">
         <Card bordered={false}   className="text-center "
            
            cover={<img alt="example" className="m-auto" src="Redmi Note 7 Pro (From ₹13,999)" src="https://rukminim1.flixcart.com/image/300/300/jt641ow0/mobile/d/w/k/mi-redmi-note-7-pro-na-original-imafe4bbyfppbnuu.jpeg?q=70" />}>
            ...
            <Card bordered={false} className="text-center "
            cover={<img alt="example" className="m-auto" src="Redmi Note 7 Pro (From ₹13,999)" src="https://rukminim1.flixcart.com/image/300/300/jvcp9jk0/mobile/a/u/x/oppo-f11-pro-cph1969-original-imafec8h3uqk3fqw.jpeg?q=70" />}>
            ...
            <Card bordered={false} className="text-center"
            cover={<img alt="example" className="m-auto" src="Redmi Note 7 Pro (From ₹13,999)" src="https://rukminim1.flixcart.com/image/300/300/jsyyufk0/mobile/b/w/f/samsung-galaxy-a50-sm-a505fzwdins-original-imafefghh95xxr6d.jpeg?q=70" />}>
            ...
            <Card bordered={false} className="text-center "
            cover={<img alt="example" className="m-auto" src="Redmi Note 7 Pro (From ₹13,999)" src="https://rukminim1.flixcart.com/image/300/300/jtrjngw0/mobile/2/t/v/realme-3-rmx1825-original-imaferd5uzuyxrsv.jpeg?q=70" />}>
